...
class Wechat
{
    ...
    public function __construct($args = [])
    {
        ...
        $this->uni_app_id = isset($args['uni_app_id']) ? $args['uni_app_id'] : null;
        $this->web_app_secret = isset($args['web_app_secret']) ? $args['web_app_secret'] : null;
        $this->web_app_id = isset($args['web_app_id']) ? $args['web_app_id'] : null;
        $this->original_id = isset($args['original_id']) ? $args['original_id'] : null;
        return $this->init();
    }
